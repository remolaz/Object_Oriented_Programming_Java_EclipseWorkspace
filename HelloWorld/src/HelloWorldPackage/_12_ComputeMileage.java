...
public class _12_ComputeMileage extends ConsoleProgram {
	...
	public void run() {
		...
		println("The distance between " + cityNames[city1] + " and " + cityNames[city2] + " is " + mileageTable[city1][city2] + " miles.");
	}
	...
	private int[][] mileageTable = {
			...
			{2625, 3016, 2052, 1341, 2327, 2369, 1134, 3303, 2841, 2816, 9810, 0},
			};
